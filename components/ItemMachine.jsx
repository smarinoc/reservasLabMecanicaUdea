...
const ItemMachine = ({ machine, isReserve, onClick }) => {
    ...
    return (
        <button onClick={()=>{onClick(); setIsSelect(!isSelect)}}>
            <div className={`flex flex-col items-center gap-3 bg-white rounded-md w-fit shadow-md pb-4 hover:border-2 hover:border-[#26DB84] ${isSelect ? "border-4 border-[#26DB84]" : ""}`}>
